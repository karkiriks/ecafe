...
<body class="bg-success">
	<div class="container">
		<div class="col-md-9">
			...
			<div class="col-md-6">
				<form:form method="post" modelAttribute="productModel" action="/ecafe/admin/product/edit">
					<div class="form-group">
						<label class="control-label" for=""></label>
						<form:input path="id" class="form-control" style="visibility:hidden;"  type="text" placeholder="id" />
					</div>
					<div class="form-group">
					...
					<div class="center" >
						<input type="submit" class="btn btn-primary pull-right" name="action" value="Edit Product"></button>
					</div>
				</form:form>
			</div>
		</div>
